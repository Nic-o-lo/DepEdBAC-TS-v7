...
$sql = "SELECT p.*, u.firstname, u.lastname,
        (SELECT s.stageName FROM tblproject_stages s WHERE s.projectID = p.projectID 
            ...
            LIMIT 1 OFFSET 0) AS first_stage_name,
        (SELECT s_current.stageName FROM tblproject_stages s_current WHERE s_current.projectID = p.projectID AND s_current.isSubmitted = 0
            ...
            LIMIT 1) AS current_unsubmitted_stage,
        (SELECT s_last_submitted.stageName FROM tblproject_stages s_last_submitted WHERE s_last_submitted.projectID = p.projectID AND s_last_submitted.isSubmitted = 1
            ...
            LIMIT 1) AS last_submitted_stage_if_all_submitted
        FROM tblproject p
...
// Helper function: Returns the status abbreviation from stage name.
...
<body>
    ...
    <!-- Top Bar: Search Bar and Add Project Button (Centered & Aligned) -->
